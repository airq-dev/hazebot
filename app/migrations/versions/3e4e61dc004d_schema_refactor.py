...
def upgrade():
    ...
    op.add_column(
        "clients",
        sa.Column(
            "alerts_disabled_at", sa.Integer(), nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "clients",
    ...
    op.add_column(
        "clients",
        sa.Column(
            "last_alert_sent_at", sa.Integer(), nullable=False, server_default="0"
        ),
    )
    op.add_column("clients", sa.Column("last_pm25", sa.Float(), nullable=True))
    op.add_column(
        "clients",
        sa.Column("num_alerts_sent", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column("clients", sa.Column("zipcode_id", sa.Integer(), nullable=True))
    op.create_index(
        op.f("ix_clients_alerts_disabled_at"),
        "clients",
        ["alerts_disabled_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_clients_last_activity_at"),
        "clients",
        ["last_activity_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_clients_last_alert_sent_at"),
        "clients",
        ["last_alert_sent_at"],
        unique=False,
    )
    op.create_foreign_key(
        "clients_zipcode_id_fkey", "clients", "zipcodes", ["zipcode_id"], ["id"]
    )
    op.add_column(
        "zipcodes",
        sa.Column(
            "max_sensor_distance", sa.Float(), nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "zipcodes",
        sa.Column(
            "min_sensor_distance", sa.Float(), nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "zipcodes",
        sa.Column("num_sensors", sa.Integer(), nullable=False, server_default="0"),
    )
    op.add_column(
        "zipcodes", sa.Column("pm25", sa.Float(), nullable=False, server_default="0")
    )
    op.add_column(
        "zipcodes",
        sa.Column("pm25_updated_at", sa.Integer(), nullable=False, server_default="0"),
    )
    op.create_index(op.f("ix_zipcodes_pm25"), "zipcodes", ["pm25"], unique=False)
    op.create_index(
        op.f("ix_zipcodes_pm25_updated_at"),
        "zipcodes",
        ["pm25_updated_at"],
        unique=False,
    )
