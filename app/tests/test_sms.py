...
class SMSTestCase(BaseTestCase):
    def test_get_quality(self):
        ...
        self.assert_twilio_response(
            ...
            "\n"
            'Thanks for texting Hazebot! We\'ll send you timely updates when AQI in your area changes based on PurpleAir data. Text Menu ("M") for more features including recommendations, or end alerts by texting ("E").\n'
            "\n"
        ...
        self.assert_twilio_response(
            "Portland 97204 is GOOD (AQI 33).\n"
            "\n"
            'We\'ll send you timely updates when AQI in your area changes based on PurpleAir data. Text Menu ("M") for more features including recommendations, or end alerts by texting ("E").',
            response.data,
        )
        self.assert_event(client_id, EventType.QUALITY, zipcode="97204", pm25=7.945)
