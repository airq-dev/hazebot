...
def linear(aqi_high: int, aqi_low: int, conc_high: float, conc_low: float, concentration: float) -> int:
    a = ((concentration - conc_low) / (conc_high - conc_low)) * (aqi_high - aqi_low) + aqi_low
    return round(a)