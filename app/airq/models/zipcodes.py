...
class Zipcode(db.Model):  # type: ignore
    ...
    pm25 = db.Column(db.Float(), nullable=False, index=True, default=0)
    pm25_updated_at = db.Column(db.Integer(), nullable=False, index=True, default=0)
    num_sensors = db.Column(db.Integer(), nullable=False, default=0)
    min_sensor_distance = db.Column(db.Float(), nullable=False, default=0)
    max_sensor_distance = db.Column(db.Float(), nullable=False, default=0)
